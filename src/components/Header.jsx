  ...
  return (
    <nav id="header">
      ...
      <div id="login_wrapper">
        ...
        {auth.isAuth() ? <Link to={"/login"}><img style={{ width: "30px", borderRadius: "15px" }} src="https://ksr-ugc.imgix.net/missing_user_avatar.png?ixlib=rb-4.0.2&w=40&h=40&fit=crop&v=&auto=format&frame=1&q=92&s=d45a87715cd7dc1eede19d8a1fcc8e62" alt="nothing" /></Link> : <Link to={"/login"}>Log in</Link>}
      </div>
    </nav>
  );
}

  ...
  return (
    <>
      <div>
        ...
        <div id="arts_2">
          <div id="arts_2_1">
            <section>
              ...
              <p id="description">
                A genre-defying musical theater production about the ocean and its environmental threats is looking to go on tour
              </p>
                ...
                <ul>
                    ...
                    <div className="card">
                      ...
                      <div className="title">
                        <p className="book_title">
                          GIRLS of NINJA HIGH SCHOOL  <br />vol.1 Collectionk</p>
                  ...
                  <li>
                    <div className="card">
                      <div className="small_img">
                        <img
                          src="https://ksr-ugc.imgix.net/assets/035/951/889/f705bb1328cc1d68484577b2513da745_original.png?ixlib=rb-4.0.2&amp;crop=faces&amp;w=1024&amp;h=576&amp;fit=crop&amp;v=1640877706&amp;auto=format&amp;frame=1&amp;q=92&amp;s=8489968b1366d6a2b5dbd5f5c8f9ff93" alt="Queen"
                        />
                      </div>
                      <div className="title">
                        <p className="book_title">
                          Make 100: Lost Queen Chronicles: <br /> The</p>
          ...
          <div id="portfolio_wrapper">
            ...
            <div id="portfolio_textWrapper">
              <div id="portfolio_text">
                ...
                <p>
                  More than 7,000 bold and brilliant short films have been funded on Kickstarter, including three Academy Award winners. These films illuminate and entertain with their beauty and depth. They tell unknown stories and amplify lesser heard voices.
                </p>
              </div>
        ...
        <div id="makeof">
          <div>
            <img src="https://ksr-static.imgix.net/CaseStudy_WaxPoetics-400x500-3-e9aa7fd.png?ixlib=rb-2.1.0&amp;auto=compress%2Cformat&amp;w=1000&amp;fit=min&amp;s=e553548f556bd28d6d687a39f918be87&quot;" alt="portfolio img" />

          </div>
          <div>
            <img src="https://ksr-static.imgix.net/tin-crop-ed2a47a.png?ixlib=rb-2.1.0&amp;auto=compress%2Cformat&amp;w=1000&amp;fit=min&amp;s=c072c44dd65b1db6bb9007e61fbc7cb4&quot;" alt="portfolio img" />
            <h3></h3>
            <p></p>
            <span></span>
          </div>
          <div>
            <img src="https://ksr-static.imgix.net/galdem-45-11cf59e.png?ixlib=rb-2.1.0&amp;auto=compress%2Cformat&amp;w=1000&amp;fit=min&amp;s=b6d4f56070e7f5aec3bafbc97316d8e0&quot;" alt="portfolio img" />
            <h3></h3>
            <p></p>
            <span></span>
          </div>
          <div>
            <img src="https://ksr-static.imgix.net/Screen_Shot_2021-03-11_at_12-14-34_PM-a2b84ac.png?ixlib=rb-2.1.0&amp;auto=compress%2Cformat&amp;w=1000&amp;fit=min&amp;s=bdaeae97bc01ea8402b4146f58cfca93&quot;);" alt="portfolio img" />
            <h3></h3>
            <p></p>
            <span></span>
          </div>
          ...
          <div id="portfolio_wrapper">
            ...
            <div id="portfolio_textWrapper">
              <div id="portfolio_text">
                ...
                <p>
                  To truly serve our mission to help bring creative projects to life, we need to build on what made Kickstarter so innovative in the first place: the power of a large network of people working together towards a common goal.
                </p>
              </div>
              <span id="link">Learn more.</span>
            </div>
          ...
          <div id="portfolio_wrapper">
            ...
            <div id="portfolio_textWrapper">
              <div id="portfolio_text">
                ...
                <p>
                  From terrific tarot decks and wizarding wands to arcane accessories, eldritch electronics, sorcerous stationery, and so much more, you can now find all the most spellbinding projects here in one place.
                </p>
              </div>
              <span id="link">Discover the magic
              </span>
            </div>
          </div>
        </div>
